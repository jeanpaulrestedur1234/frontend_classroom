...
export default function RoomInfoCard({ availability }: RoomInfoCardProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-4 p-5 rounded-2xl bg-zinc-50 backdrop-blur-xl border border-zinc-200">
      <div className="flex items-center gap-3 flex-1">
        <div className="w-10 h-10 rounded-xl bg-amber-500/10 flex items-center justify-center shrink-0">
          <Building2 className="w-5 h-5 text-amber-400" />
        </div>
        <div>
          <h2 className="text-base font-semibold text-zinc-900 font-[family-name:var(--font-display)]">
